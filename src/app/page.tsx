    ...
    <>
      ...
      <div className="card" style={{ marginTop: 16 }}>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.8 }}>
          当前定位：工作台框架已具备，工程执行链路正在接入，客户工程效果尚待验证。<br />
          网站版本：V0.2.2（提交 f92ea1b，WEB-R01—08 及两轮复核意见已整改，待项目总控复验）。<br />
          本地 AtmEdge 验证：推进中（本地闭环，与网站整改解耦）。<br />
          云边接口联调：未开始 — 按独立任务卡执行，不因客户图纸缺失整体停住。<br />
          客户制图验证：HOLD — 客户样本、参数变更单、验收标准未齐。<br />
          智能报价：规划能力 — 待成本规则、报价口径与审批要求明确后实施。
        </p>
      </div>
